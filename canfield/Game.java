...
class Game {
    ...
    /** Rectangle frame of the Stock Pile. */
    static final Rectangle STOCK_PILE = new Rectangle(100, 550, 90, 125);

    /** Rectangle frame of the Foundation Pile 1. */
    static final Rectangle FOUNDATION_PILE1 = new Rectangle(475, 150, 90, 125);

    /** Rectangle frame of the Foundation Pile 2. */
    static final Rectangle FOUNDATION_PILE2 = new Rectangle(590, 150, 90, 125);

    /** Rectangle frame of the Foundation Pile 3. */
    static final Rectangle FOUNDATION_PILE3 = new Rectangle(705, 150, 90, 125);

    /** Rectangle frame of the Foundation Pile 4. */
    static final Rectangle FOUNDATION_PILE4 = new Rectangle(820, 150, 90, 125);

    /** Rectangle frame of the Tableau Pile 1. */
    static final Rectangle TABLEAU_PILE1 = new Rectangle(475, 350, 90, 125);

    /** Rectangle frame of the Tableau Pile 2. */
    static final Rectangle TABLEAU_PILE2 = new Rectangle(590, 350, 90, 125);

    /** Rectangle frame of the Tableau Pile 3. */
    static final Rectangle TABLEAU_PILE3 = new Rectangle(705, 350, 90, 125);

    /** Rectangle frame of the Tableau Pile 4. */
    static final Rectangle TABLEAU_PILE4 = new Rectangle(820, 350, 90, 125);

    /** Rectangle frame of the Reserve Pile. */
    static final Rectangle RESERVE_PILE = new Rectangle(100, 350, 90, 125);

    /** Rectangle frame of the Waste Pile. */
    static final Rectangle WASTE_PILE = new Rectangle(215, 550, 90, 125);
    ...
    /** Save the current state of the game, normally before a legit move. */
    void saveStates() {
        Game currentGame = new Game(this);
        states.add(currentGame);
    }

    /** Restore to the previous state of the game. */
    void undo() {
        if (!states.isEmpty()) {
            Game desiredState = states.get(states.size() - 1);
            states.remove(states.size() - 1);
            copyFrom(desiredState);
        }
    }
    ...
    /** Return the second top of the waste. */
    Card secondTopWaste() {
        return _waste.get(1);
    }
    ...
    /** Getter for clicked Card.
    * @return Card "the clicked card".
    */
    Card getClickedCard() {
        return clickedCard;
    }

    /** Setter for clicked Card.
    * @param c that set equal to clicked card.
    */
    void setClickedCard(Card c) {
        clickedCard = c;
    }

    /** Getter of _tableau. */
    /** @return ArarayList<Pile>. */
    public ArrayList<Pile> getTableau() {
        return _tableau;
    }
    ...
    /** List of game states. */
    private ArrayList<Game> states = new ArrayList<>();
}
